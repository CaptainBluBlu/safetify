    ...
    <Row>
      <Col xl={4}>
        <Card>
          ...
          <Card.Body>
            <div className="text-center chat-image mb-5">
              <div className="avatar avatar-xxl chat-profile mb-3 brround">
                <Link className="" href={`/components/pages/profile/`}><img alt="avatar" src={"../../../assets/images/users/7.jpg"} className="brround"/></Link>
              </div>
          ...
          <Card.Footer className="text-end">
            <Link href="#" className="btn btn-primary me-2">Update</Link>
            <Link href="#" className="btn btn-danger me-2">Cancel</Link>
          </Card.Footer>
        </Card>
            ...
            <ListGroup className="no-margin">
              <ListGroup.Item className="d-flex ps-3">
                <div className="social social-profile-buttons me-2">
                  <Link className="social-icon text-primary" href=""><i className="fe fe-mail"></i></Link>
                </div>
                <span className="my-auto">support@demo.com</span>
              </ListGroup.Item>
              <ListGroup.Item className="d-flex ps-3">
                <div className="social social-profile-buttons me-2">
                  <Link className="social-icon text-primary" href="#"><i className="fe fe-globe"></i></Link>
                </div>
                <span className="my-auto">www.abcd.com</span>
              </ListGroup.Item>
              <ListGroup.Item className="d-flex ps-3">
                <div className="social social-profile-buttons me-2">
                  <Link className="social-icon text-primary" href="#"><i className="fe fe-phone"></i></Link>
                </div>
      ...
      <Col xl={8}>
        <Card>
          ...
          <Card.Footer className="text-end">
            <Link href="#" className="btn btn-success me-2">Save</Link>
            <Link href="#" className="btn btn-danger me-2">Cancel</Link>
          </Card.Footer>
        </Card>
        <Row>
        ...
        <Card>
          ...
          <Card.Footer className="text-end">
            <Link href="#" className="btn btn-primary my-1 me-2">Deactivate</Link>
            <Link href="#" className="btn btn-danger my-1 me-2">Delete Account</Link>
          </Card.Footer>
        </Card>
      </Col>
    </Row>
