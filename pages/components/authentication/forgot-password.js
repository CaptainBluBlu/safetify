...
const ForgotPassword = () => {
  ...
  <div >
    ...
    <Col className="col-login mx-auto">
      ...
      <img src={"../../../assets/images/brand/safetify-white.png"} className="header-brand-img m-0" alt="" height={100} width={100} />
      </div>
    </Col>
      ...
      <div className="wrap-login100 p-6">
        <form className="login100-form validate-form">
          ...
          <div className="submit">
            <Link className="btn btn-primary d-grid" href={`/components/pages/login/`}>Submit</Link>
          </div>
          <div className="text-center mt-4">
            <p className="text-dark mb-0 mx-2"><Link className="text-primary ms-1" href={`/components/pages/login`}>Back</Link></p>
          </div>
