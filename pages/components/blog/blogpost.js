...
const Userlist = () => {
  ...
  return (
    <div >
      ...
      <PageHeader titles="My Journal" active="My Journal" items={['Journaling']} />
        ...
        <Col lg={12} xl={12} >
          ...
          <Card>
            <Card.Header className="border-bottom-0 p-4">
              <Card.Title>12 Journals</Card.Title>
              <div className="d-flex page-options ms-auto">
                  <Form.Group className='mb-3'>
                    <Select classNamePrefix="Select" options={FormSize} placeholder='Select' onChange={(e) => setPageSize(Number(e.value))} />
                  </Form.Group>
                </div>
            </Card.Header>
