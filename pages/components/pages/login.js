      ...
      <Seo title="Login"/>
        ...
        <Col className="col-login mx-auto mt-7">
          <div className="text-center">
            <img src={"../../../assets/images/brand/safetify-white.png"} className="header-brand-img" alt="" height={100} width={100} />
          </div>
        </Col>
                    ...
                    <Tabs defaultActiveKey="Email" id="uncontrolled-tab-example" className="tab-content">
                      <Tab eventKey="Email" title="Email" className='p-0 pt-5'>
                          ...
                          <div className="text-center pt-4">
                            <p className="mb-0 fs-13"><Link href={`/components/pages/forgot-password`} className="text-primary ms-1">Forgot Password?</Link></p>
                          </div>
                          <div className="container-login100-form-btn">
                            <Link href={`/components/dashboard/dashboard/`} className="login100-form-btn btn-primary">
                              Login
                            </Link>
                          </div>
                          <div className="text-center pt-3">
                            <p className="text-dark mb-0 fs-13 mx-3">Not a member?<Link href={`/components/pages/register`} className="text-primary ms-1">Sign Up</Link></p>
                          </div>
