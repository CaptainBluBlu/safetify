...
import { DropzoneDisabled } from './Forms/FormAdvanceData/DataFormAdvanced';
        ...
        <Card>
          ...
          <Card.Footer>
            ...
            <Row>
              <Col md={3}></Col>
              <Col md={9}>
                <Link href="#" className="btn btn-primary">Add Product</Link>
                <Link href="#" className="btn btn-default float-end">Discard</Link>
              </Col>
            </Row>
            {/* <!--End Row--> */}
          </Card.Footer>
