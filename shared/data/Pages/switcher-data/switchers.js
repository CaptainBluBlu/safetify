            ...
            <Card className="sidebar-right1">
              ...
              <Card.Body>
                ...
                <div className="skin-body switch_section">
                  ...
                  <div className="switch-toggle d-flex mt-2">
                    <Link className="bg-img1 me-2" href="#" onClick={() => SwitcherData.bgimage1()} ><img src={"../../../assets/images/media/bg-img1.jpg"} className='br-7' alt="Bg-1" id="bgimage1" /></Link>
                    <Link className="bg-img2 me-2" href="#" onClick={() => SwitcherData.bgimage2()}><img src={"../../../assets/images/media/bg-img2.jpg"} className='br-7' alt="Bg-2" id="bgimage2" /></Link>
                    <Link className="bg-img3 me-2" href="#" onClick={() => SwitcherData.bgimage3()}><img src={"../../../assets/images/media/bg-img3.jpg"} className='br-7' alt="Bg-3" id="bgimage3" /></Link>
                    <Link className="bg-img4 me-2" href="#" onClick={() => SwitcherData.bgimage4()}><img src={"../../../assets/images/media/bg-img4.jpg"} className='br-7' alt="Bg-4" id="bgimage4" /></Link>
                  </div>
                </div>
              </Card.Body>
              <Card.Body>
