...
import {ItemData} from './reduxdata';
            ...
            <div className="product-grid6">
              <div className="product-image6 p-5">
                <ul className="icons-wishlist">
                  <li><Link href='#' onClick={() => handleRemove(item.id)} className="btn btn-danger"><i className="fe fe-heart"></i></Link></li>
                </ul>
              ...
              <Card.Body className="pt-0">
                <div className="product-content text-center">
                  <h1 className="title fw-bold fs-20"><Link href={`/components/e-commerce/shopping-cart/`}>{item.heading}</Link></h1>
              ...
              <Card.Footer className="text-center">
                <Link href={`/components/e-commerce/shopping-cart/`} className="btn btn-primary ms-2 mb-1"><i className="fe fe-shopping-cart me-2"></i>Add to cart</Link>
