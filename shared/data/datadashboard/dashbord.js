              ...
              <ul className="task-list">
                <li className="d-sm-flex">
                  ...
                  <div className="ms-auto d-md-flex">
                    <Link href="#" ><OverlayTrigger placement="top" overlay={<Tooltip >Edit</Tooltip>}><span className="fe fe-edit me-2 text-muted"></span></OverlayTrigger></Link>
                    <Link href="#" ><OverlayTrigger placement="top" overlay={<Tooltip >Delete</Tooltip>}><span className="fe fe-trash-2 text-muted"></span></OverlayTrigger></Link>
                  </div>
                </li>
                <li className="d-sm-flex">
                  <div>
                    ...
                    <p className="text-muted fs-12">Victoria commented on Project <Link
                      href="#" className="fw-semibold"> AngularJS Template</Link></p>
                  </div>
                  <div className="ms-auto d-md-flex">
                    <Link href="#" ><OverlayTrigger placement="top" overlay={<Tooltip >Edit</Tooltip>}><span className="fe fe-edit me-2 text-muted"></span></OverlayTrigger></Link>
                    <Link href="#" ><OverlayTrigger placement="top" overlay={<Tooltip >Delete</Tooltip>}><span className="fe fe-trash-2 text-muted"></span></OverlayTrigger></Link>
                ...
                <li className="d-sm-flex">
                  <div>
                    ...
                    <p className="text-muted mb-0 fs-12">Petey Cruiser finished task <Link
                      href="#" className="fw-semibold"> Integrated management</Link></p>
                  </div>
                  <div className="ms-auto d-md-flex">
                    <Link href="#" ><OverlayTrigger placement="top" overlay={<Tooltip >Edit</Tooltip>}><span className="fe fe-edit me-2 text-muted"></span></OverlayTrigger></Link>
                    <Link href="#" ><OverlayTrigger placement="top" overlay={<Tooltip >Delete</Tooltip>}><span className="fe fe-trash-2 text-muted"></span></OverlayTrigger></Link>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="browser-stats">
                ...
                <Row className="mb-4">
                  <Col sm={2} lg={3} xl={3} xxl={2} className="mb-sm-0 mb-3">
                    <img src="../../../assets/images/browsers/uc-browser.svg" className="img-fluid"
                      alt="img" />
                  </Col>
                  <Col sm={10} lg={9} xl={9} xxl={10} className="ps-sm-0">
                    <div className="d-flex align-items-end justify-content-between mb-1">
