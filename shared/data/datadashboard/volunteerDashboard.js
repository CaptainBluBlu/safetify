...
import { AllProduct, Shipped, Pending, Cancelled } from "./dashboarddata";
			...
			<Row>
				<Col sm={12} md={12} lg={12} xl={8} xxl={9}>
					<Card>
						...
						<Card.Body>
							<div className="chartjs-wrapper-demo myChartSaah"></div>
						</Card.Body>
					</Card>
				</Col>
				{/* <!-- COL END --> */}
				<Col md={12} sm={12} lg={12} xl={4} xxl={3}>
					<Card className="overflow-hidden">
						<Card.Body className="pb-0 bg-recentorder">
							...
							<div className="chartjs-wrapper-demo"></div>
						</Card.Body>
						...
						<Card.Body>
							<div className="browser-stats">
								...
								<Row className="mb-4">
									<Col sm={2} lg={3} xl={3} xxl={2} className="mb-sm-0 mb-3">
										<img
											src="../../../assets/images/browsers/uc-browser.svg"
											className="img-fluid"
											alt="img"
										/>
									</Col>
