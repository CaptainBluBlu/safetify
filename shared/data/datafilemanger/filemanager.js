    ...
    <div>
        ...
        <Card>
          ...
          <Card.Body className="pt-4">
            <ListGroup className="list-group-transparent mb-0 file-manager">
              <div className="d-flex">
                <div><Link href="#" className="list-group-item  d-flex align-items-center px-0"><i className="fe fe-image fs-18 me-2 text-success p-2"></i>Images</Link></div>
              ...
              <div className="d-flex">
                <div><Link href="#" className="list-group-item  d-flex align-items-center px-0"><i className="fe fe-video fs-18 me-2 text-secondary p-2"></i>Videos</Link></div>
              ...
              <div className="d-flex">
                <div><Link href="#" className="list-group-item  d-flex align-items-center px-0"><i className="fe fe-file-text fs-18 me-2 text-primary p-2"></i> Docs</Link></div>
              ...
              <div className="d-flex">
                <div><Link href="#" className="list-group-item  d-flex align-items-center px-0"><i className="fe fe-music fs-18 me-2 text-warning p-2"></i> Music</Link></div>
              ...
              <div className="d-flex">
                <div><Link href="#" className="list-group-item  d-flex align-items-center px-0"><i className="fe fe-download fs-18 me-2 text-info p-2"></i> Downloads</Link></div>
              ...
              <div className="d-flex">
                <div><Link href="#" className="list-group-item  d-flex align-items-center px-0"><i className="fe fe-grid fs-18 me-2 text-danger p-2"></i> More</Link></div>
          ...
          <Card.Body>
            <ListGroup className="list-group-transparent mb-0">
              <Link href="#" className="list-group-item  d-flex align-items-center px-0 py-2"><span className="text-primary me-2 fs-12"><i className="fe fe-circle"></i></span>Remote Control</Link>
              <Link href="#" className="list-group-item  d-flex align-items-center px-0 py-2"><span className="text-secondary me-2 fs-12"><i className="fe fe-circle"></i></span>Google Drive</Link>
              <Link href="#" className="list-group-item  d-flex align-items-center px-0 py-2"><span className="text-danger me-2 fs-12"><i className="fe fe-circle"></i></span>FTP Files</Link>
              <Link href="#" className="list-group-item  d-flex align-items-center px-0 py-2"><span className="text-warning me-2 fs-12"><i className="fe fe-circle"></i></span>Transfer files</Link>
              <Link href="#" className="list-group-item  d-flex align-items-center px-0 py-2"><span className="text-success me-2 fs-12"><i className="fe fe-circle"></i></span>Deep Clean</Link>
              <Link href="#" className="list-group-item  d-flex align-items-center px-0 py-2"><span className="text-info me-2 fs-12"><i className="fe fe-circle"></i></span>Favourities</Link>
              <Link href="#" className="list-group-item  d-flex align-items-center px-0 py-2"><span className="text-pink me-2 fs-12"><i className="fe fe-circle"></i></span>Settings</Link>
            </ListGroup>
          </Card.Body>
        </Card>
      ...
      <Col md={7} lg={7} xl={9}>
        <Row className="row-sm">
          ...
          <Col xl={3} md={6} sm={6}>
            <Card className="pos-relative">
              <Link href={`/components/filemanager/file-manager-list`} className="open-file"></Link>
        ...
        <Row className="row-sm">
          ...
          <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
            <Card className="overflow-hidden">
              <Link href={`/components/filemanager/file-details/`}><img src={"../../../assets/images/media/files/07.jpg"} alt="img" className="w-100 file-manager-list" /></Link>
              <Card.Footer>
                <div className="d-flex">
                  <div className="">
          ...
          <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
            <Card className="overflow-hidden">
              <Link href={`/components/filemanager/file-details/`}><img src={"../../../assets/images/media/files/06.jpg"} alt="img" className="w-100 file-manager-list" /></Link>
              <Card.Footer>
                <div className="d-flex">
                  <div className="">
          ...
          <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
            <Card className="overflow-hidden">
              <Link href={`/components/filemanager/file-details/`} className="mx-auto my-3"><img src={"../../../assets/images/media/files/documents/10.png"} alt="img" /></Link>
              <Card.Footer>
                <div className="d-flex">
                  <div className="">
          ...
          <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
            <Card className="overflow-hidden">
              <Link href={`/components/filemanager/file-details/`} className="mx-auto my-3"><img src={"../../../assets/images/media/files/documents/8.png"} alt="img" /></Link>
              <Card.Footer>
                <div className="d-flex">
                  <div className="">
          ...
          <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
            <Card className="overflow-hidden">
              <Link href={`/components/filemanager/file-details/`}><img src={"../../../assets/images/media/files/01.jpg"} alt="img" className="w-100 file-manager-list" /></Link>
              <Card.Footer>
                <div className="d-flex">
                  <div className="">
          ...
          <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
            <Card className="overflow-hidden">
              <Link href={`/components/filemanager/file-details/`}><img src={"../../../assets/images/media/files/02.jpg"} alt="img" className="w-100 file-manager-list" /></Link>
              <Card.Footer>
                <div className="d-flex">
                  <div className="d-flex">
                    <h5 className="mb-0 fw-semibold text-break">image1.jpg</h5>
          ...
          <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
            <Card className="overflow-hidden">
              <Link href={`/components/filemanager/file-details/`}><img src={"../../../assets/images/media/files/04.jpg"} alt="img" className="w-100 file-manager-list" /></Link>
              <Card.Footer>
                <div className="d-flex">
                  <div className="">
          ...
          <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
            <Card className="overflow-hidden">
              <Link href={`/components/filemanager/file-details/`}><img src={"../../../assets/images/media/files/05.jpg"} alt="img" className="w-100 file-manager-list" /></Link>
              <Card.Footer>
                <div className="d-flex">
                  <div className="">
                    <h5 className="mb-0 fw-semibold text-break">nature.jpg</h5>
          ...
          <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
            <Card className="overflow-hidden">
              <Link href={`/components/filemanager/file-details/`} className="mx-auto my-3"><img src={"../../../assets/images/media/files/documents/9.png"} alt="img" /></Link>
              <Card.Footer>
                <div className="d-flex">
                  <div className="">
