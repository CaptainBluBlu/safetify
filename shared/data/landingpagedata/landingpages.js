              ...
              <div className="d-flex">
                ...
                <Navbar className="d-flex order-lg-2 ms-auto header-right-icons">
                  ...
                  <div className="demo-icon  nav-link icon">
                    {" "}
                    <i
                      className="fe fe-settings fa-spin  text_primary"
                  ...
                  <Row>
                    <Navbar className="main-sidemenu navbar px-0 justify-content-between">
                      ...
                      <div className="header-nav-right d-lg-flex d-none">
                        <Link
                          href={`/components/authentication/register/`}
                          className="btn ripple btn-min w-sm btn-outline-primary me-2 my-auto d-lg-none d-xl-block d-block"
                        >
                          New User
                        </Link>
                        <Link
                      ...
                      <div className="demo-icon demoicon nav-link icon">
                        {" "}
                        <i
                          className="fe fe-settings fa-spin  text_primary"
                          onClick={() => SidSwitcherIcon()}
                ...
                <Row>
                  ...
                  >
                    ...
                    <h1 className="text-start fw-bold">
                      We Help to Build Your Dream Project with{" "}
                      <span className="text-primary animate-heading">Sash</span>
                    </h1>
                    <h6 className="pb-3">
                      Sash - Now you can use this admin template to design
                      stunning dashboards that will wow your target viewers or
                      users to no end. To create a good and well-structured
                      dashboard, you need to start from scratch with HTML, SCSS,
                      CSS, and JS and with lots of coding, but by using this
                      Sash-Admin template.
                    </h6>
                    <Link
                      href="#"
            ...
            <div className="side-app">
              ...
              <div className="main-container">
                <div className="">
                    ...
                    <Container>
                      <Row>
                        ...
                        <Row className="mt-7">
                          ...
                          <Col lg={6} md={12}>
                            <Card
                              className="features main-features main-features-9 wow fadeInUp"
                              data-wow-delay="0.1s"
                            >
                              <div className="bg-img mb-2 text-left">
                                <svg
                          ...
                          <Col lg={6} md={12}>
                            <Card
                              className="features main-features main-features-12 mb-4 wow fadeInUp"
                              data-wow-delay="0.1s"
                            >
                              <div className="bg-img mb-2 text-left">
                                <svg
                  ...
                  {/* <!-- ROW-3 OPEN --> */}
                  <div
                    className="section bg-landing pb-0 bg-image-style"
                    id="About"
                  >
                    <Container>
                      <Row>
                              ...
                              <div className="statistics-info">
                                <Row>
                                  ...
                                  <Col xl={6} lg={6} className="pe-0 my-auto">
                                    <div className="ps-5">
                                      <h2 className="text-start fw-semibold fs-25 mb-6">
                              ...
                              <Col lg={12}>
                                <Row className="justify-content-center">
                                  <Col
                                    lg={9}
                                    as="p"
                                    className="text-default sub-text mb-7"
                                  >
                                    The Sash admin template is one of the modern
                                    dashboard templates. It is also a premium
                                    admin dashboard with high-end features,
                                    where users can easily customize or change
                                    their projects according to their choice.
                                    Please take a quick look at our template
                                    highlights.
                                  </Col>
                                </Row>
                                <Row id="grid">
                                  <Col lg={6}>
                                    ...
                                    >
                                      <Accordion className="bg-primary-transparent p-0 ">
                                        ...
                                        >
                                          <Accordion.Header className="card-options-collapse h5 fw-bold mb-0 text-primary">
                                            Switch Easily From Vertical to
                                            Horizontal Menu
                                          </Accordion.Header>
                                          <Accordion.Body className="pt-0">
                                            <p>
                                              The Sash – Bootstrap 5 Admin &
                                        ...
                                        >
                                          ...
                                          <Accordion.Body className="pt-0">
                                            <p>
                                              ...
                                              available in two different types
                                              of layouts
                                              {` "Fixed Layout" and "Scrollable Layout".`}{" "}
                                              Here users can switch their
                                              Template from one layout to
                    ...
                    <Container>
                      <Row>
                            ...
                            <Card.Body className="px-1">
                              <div className="d-sm-flex overflow-visible">
                                ...
                                <div className="ps-3 flex-column">
                                  ...
                                  <h3>
                                    <Link
                                      href={`/components/pages/extension/blog-details/`}
                                    >
                        ...
                        <div className="text-center mt-5">
                          <Link
                            href={`/components/pages/extension/blog/`}
                    ...
                    <Row>
                      ...
                      <Col lg={2} sm={6} md={4} className="">
                        ...
                        <ul className="list-unstyled mb-5 mb-lg-0">
                          ...
                          <li>
                            <Link href={`/components/bootstrap/alerts/`}>
                              Elements
                            </Link>
                          </li>
                          <li>
                            <Link
                              href={`/components/pages/forms/form-elements/`}
                            >
                              Forms
                            </Link>
                          </li>
                          <li>
                            <Link href={`/components/charts/chartjs/`}>
                              Charts
                            </Link>
                          </li>
                          <li>
                            <Link href={`/components/pages/tables/data-table/`}>
                              Tables
                            </Link>
                          </li>
                          <li>
                            <Link
                              href={`/components/filemanager/file-attachments/`}
                            >
                              Other Pages
                            </Link>
                          </li>
                      ...
                      <Col lg={2} sm={6} md={4} className="">
                        ...
                        <ul className="list-unstyled mb-5 mb-lg-0">
                          <li>
                            <Link
                              href={`/components/pages/extension/about-company/`}
                            >
                              Our Team
                            </Link>
                          </li>
                          ...
                          <li>
                            <Link
                              href={`/components/pages/extension/services/`}
                            >
                              Services
                            </Link>
                          </li>
                          <li>
                            <Link href={`/components/pages/extension/blog/`}>
                              Blog
                            </Link>
                          </li>
                          <li>
                  ...
                  <footer className="main-footer px-0 pb-0 text-center">
                    <Row>
                      <Col md={12} sm={12}>
                        ...
                        <Link href="#">Sash</Link>. Designed with{" "}
