                  ...
                  <div className="d-flex order-lg-2">
                    ...
                    <Dropdown className="shopping-cart">
                      ...
                      <Dropdown.Menu className="dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <PerfectScrollbar style={{ height: "300px" }}>
                          <Dropdown.Item href={`/components/e-commerce/shopping-cart/`} className="d-flex p-4">

                            <img className="avatar avatar-xl br-5 me-3 align-self-center cover-image" src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/products/3.jpg`}alt='pngs-4' />
                          ...
                          <Dropdown.Item href={`/components/e-commerce/shopping-cart/`} className="d-flex p-4">
                            ...
                            <img
                              ...
                              src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/products/5.jpg`}/>
                            <div className="wd-50p">
                          ...
                          <Dropdown.Item href={`/components/e-commerce/shopping-cart/`} className="d-flex p-4">
                            ...
                            <img
                              ...
                              src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/products/11.jpg`}/>
                            <div className="wd-50p">
                          ...
                          <Dropdown.Item href={`/components/e-commerce/shopping-cart/`} className="d-flex p-4">
                            ...
                            <img
                              ...
                              src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/products/1.jpg`}/>
                            <div className="wd-50p">
                          ...
                          <Dropdown.Item href={`/components/e-commerce/shopping-cart/`} className="d-flex p-4">
                            ...
                            <img
                              ...
                              src={`${process.env.NODE_ENV === 'production'? basePath : ''}/assets/images/products/2.jpg`}/>
                            <div className="wd-50p">
                    ...
                    <Dropdown className="notifications">
                      ...
                      <Dropdown.Menu className="dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <div className="notifications-menu">
                          <Dropdown.Item className="d-flex" href={`/components/pages/notifications-list`}>
                            <div
                    ...
                    <Dropdown className=" message">
                      ...
                      <Dropdown.Menu className="dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <div className="message-menu">
                          <Dropdown.Item className="d-flex" href={`/components/apps/chat/`}>
                            <img
                        ...
                        <div className="dropdown-divider m-0"></div>
                        <Dropdown.Item href="#" className="text-center p-3 text-muted">See all
                    ...
                    <Dropdown className=" profile-1">
                      ...
                      <Dropdown.Menu className="dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <div className="dropdown-divider m-0"></div>
                        <Dropdown.Item className="dropdown-item" href={`/components/pages/profile/`}>
                          <i className="dropdown-icon fe fe-user"></i> Profile
                        </Dropdown.Item>
                        <Dropdown.Item className="dropdown-item" href={`/components/pages/mail-index/`}>
