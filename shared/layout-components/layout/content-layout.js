...
const Switcher = dynamic(() => import("../switcher/switcherComponent.js"), { ssr: false });
...
const Contentlayout = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if(localStorage.getItem("sashhorizontal") || localStorage.getItem("sashhorizontalHover")){
  ...
  const remove = () => {
    ...
    document.querySelectorAll(".slide-menu").forEach((res)=>{
      if(res.classList.contains("open") && document.body.classList.contains("horizontal-hover")){
      ...
      <Provider store={store}>
        ...
        <div className="horizontalMenucontainer">
          ...
          <div className="page-main">
            ...
            <div className="main-content app-content mt-0" onClick={() => remove()}>
